            ...
            <CardContent className="p-6">
              ...
              <div className="text-muted-foreground space-y-3">
                <div>
                  ...
                  <p className="text-sm">(gratuita ou paga, você escolhe) Uma conversa inicial para entender sua história, suas dúvidas, desafios e desejos.</p>
                </div>
                <div>
                  <p className="font-semibold text-foreground">2. Proposta personalizada</p>
                  <p className="text-sm">Sugestão de um plano com sessões semanais online, usando exercícios práticos, orientações energéticas e produtos sensoriais.</p>
                </div>
                <div>
                  <p className="font-semibold text-foreground">3. Caminho com presença</p>
                  <p className="text-sm">Cada encontro é único, respeitando o seu tempo e seu momento.</p>
                </div>
              </div>
            </CardContent>
          </Card>
